...
namespace AviFile
{
	public class AviManager
	{
        ...
        public VideoStream AddVideoStream(Avi.AVICOMPRESSOPTIONS compressOptions, double frameRate, int frameSize, int width, int height, PixelFormat format)
        {
            VideoStream stream = new VideoStream(aviFile, compressOptions, frameRate, frameSize, width, height, format);
            streams.Add(stream);
            return stream;
        }
